...
RSpec.describe GameReviewsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      game_review = GameReview.create! valid_attributes
      get :show, {:id => game_review.to_param}, valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new GameReview" do
        expect {
          post :create, {:game_review => valid_attributes}, valid_session
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the game_review" do
        game_review = GameReview.create! valid_attributes
        put :update, {:id => game_review.to_param, :game_review => valid_attributes}, valid_session
